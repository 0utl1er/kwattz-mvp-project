    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-blue-950">
              Smart Energy Management with <span className="text-teal-600">kWattz</span>
            </h1>
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-4">
              <Button className="text-lg py-6 px-8 bg-teal-600 hover:bg-teal-700" asChild>
                <Link to="/signup">Get Started <ArrowRight className="ml-2" /></Link>
              </Button>
              <Button variant="outline" className="text-lg py-6 px-8 border-teal-600 text-teal-600 hover:bg-teal-50" asChild>
                <Link to="/login">Login</Link>
              </Button>
            </div>
          </div>
          <div className="flex-1 flex justify-center">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-6 border border-teal-100">
              <div className="bg-teal-50 rounded-xl p-4 mb-4">
                <h3 className="text-xl font-semibold text-teal-800 mb-2">Your Energy Advisor</h3>
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-teal-50 rounded-xl p-6 text-center shadow-md hover:shadow-lg transition-shadow">
              <div className="bg-teal-100 mx-auto mb-4 rounded-full w-12 h-12 flex items-center justify-center">
                <span className="text-teal-600 font-bold text-xl">1</span>
              </div>
              <h3 className="text-xl font-semibold mb-2 text-teal-800">Create Account</h3>
            ...
            <div className="bg-teal-50 rounded-xl p-6 text-center shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-2 text-teal-800">Answer Questions</h3>
            ...
            <div className="bg-teal-50 rounded-xl p-6 text-center shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-2 text-teal-800">Upload Bill</h3>
            ...
            <div className="bg-teal-50 rounded-xl p-6 text-center shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-2 text-teal-800">Get Insights</h3>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-3 text-teal-800">AI-Powered Analysis</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-3 text-teal-800">Personalized Education</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold mb-3 text-teal-800">Ongoing Monitoring</h3>
      ...
      <section className="py-16 bg-gradient-to-r from-teal-600 to-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button className="bg-white text-teal-600 hover:bg-blue-50 text-lg py-6 px-8" asChild>
          ...
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-8 md:mb-0">
              <h3 className="text-2xl font-bold text-white mb-4">
                <span className="text-teal-400">k</span>Wattz
              </h3>
