...
const Chat = () => {
  ...
  return (
    <div className="flex flex-col h-[500px] md:h-[600px] w-full max-w-4xl mx-auto bg-[#091544]/90 backdrop-blur-xl rounded-xl border border-[#C3FF44]/20 shadow-2xl relative overflow-hidden">
      ...
      <div className="p-2 md:p-4 border-t border-[#C3FF44]/20 bg-[#091544]/95">
        <div className="flex gap-2 items-center">
          ...
          <Button 
            ...
            size="icon"
            disabled={true}
            className="bg-[#C3FF44]/50 text-[#091544] h-10 md:h-11 w-10 md:w-11"
          >
